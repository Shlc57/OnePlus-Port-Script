...
def test_oneplus_adfr_rus_payload_and_jar_patcher_contract() -> None:
    module_spec = importlib.util.spec_from_file_location(
        "fix_oplus_ltpo_adfr_rus", PATCH_DIR / "adfr_rus.py"
    )
    ...
    patcher_spec = importlib.util.spec_from_file_location(
        "fix_oplus_ltpo_miui_services_patcher", PATCH_DIR / "patch_miui_services_adfr.py"
    )
...
def test_oneplus_apollo_panel_nit_contract() -> None:
    module_spec = importlib.util.spec_from_file_location(
        "fix_oplus_ltpo_apollo_panel_nit", PATCH_DIR / "patch_apollo_panel_nit.py"
    )
    assert module_spec is not None and module_spec.loader is not None
    module = importlib.util.module_from_spec(module_spec)
    module_spec.loader.exec_module(module)
