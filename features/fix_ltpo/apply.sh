...
prepare_apollo_panel_nit() {
	...
	apollo_context_patch="$(mktemp "$(get_config_path '.fix_ltpo_apollo_contexts.XXXXXX')")"
	apollo_fsconfig_patch="$(mktemp "$(get_config_path '.fix_ltpo_apollo_fsconfig.XXXXXX')")"
	temporary_vendor_contexts="$(mktemp "$(get_config_path '.fix_ltpo_vendor_contexts.XXXXXX')")"
	temporary_vendor_fsconfig="$(mktemp "$(get_config_path '.fix_ltpo_vendor_fsconfig.XXXXXX')")"
	temporary_files+=(
...
temporary_property_contexts="$(mktemp "$(get_config_path '.fix_ltpo_property_contexts.XXXXXX')")"
temporary_odm_contexts="$(mktemp "$(get_config_path '.fix_ltpo_odm_contexts.XXXXXX')")"
temporary_odm_fsconfig="$(mktemp "$(get_config_path '.fix_ltpo_odm_fsconfig.XXXXXX')")"
temporary_odm_build_prop="$(mktemp "$(get_config_path '.fix_ltpo_odm_build_prop.XXXXXX')")"
temporary_files+=(
...
if [[ -L "$vendor_build_prop" ]]; then
	...
	temporary_vendor_build_prop="$(mktemp "$(get_config_path '.fix_ltpo_vendor_build_prop.XXXXXX')")"
